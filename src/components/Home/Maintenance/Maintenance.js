...
export default function Maintenance() {
  return (
    <div className="relative flex items-center justify-center w-full min-h-screen snap-mandatory bg-primary">
      <section className="bg-transparent bg-white">
        <div className="max-w-screen-md px-4 py-8 mx-auto text-center lg:py-16 lg:px-12">
          ...
          <h1 className="mb-4 text-4xl font-bold leading-none tracking-tight text-gray-900 lg:mb-6 md:text-5xl xl:text-6xl dark:text-white">
            Under Maintenance
          </h1>
          ...
          <p className="font-light text-white-500 md:text-lg xl:text-xl dark:text-gray-400">
            ...
            <a
              ...
              href="mailto:gbolaga@famodun.com?subject=Hello%20World&body=Body%20of%20the%20email"
            >
              gbolaga@famodun.com
            </a>
          </p>

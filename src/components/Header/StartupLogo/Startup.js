...
const Startup = (props) => {
  ...
  <motion.div 
    initial={{opacity:1}}
    animate={{opacity:0}}
    transition={{opacity:{delay:2.9,duration:0}}}
    className="absolute flex items-center justify-center w-full h-full bg-StartupBackground">
      <motion.div
      ...
      >
        <motion.div
          ...
          className="absolute w-12 h-2 rounded bg-secondary "
        ></motion.div>
        <motion.div
          initial={{ scale: 0, x: 0 }}
        ...
        <motion.span
          ...
          className="text-4xl text-secondary font-Text2"
        >
          M
        </motion.span>
      </motion.div>
